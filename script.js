gsap.registerPlugin(ScrollTrigger);
    ...
    //stars
    scene3.fromTo("#stars", { opacity: 0 }, { opacity: 01, y: -500 }, 0)

    // Scroll Back text
    scene3.fromTo("#arrow2", { opacity: 0 }, { opacity: 0.3, y: -710 }, 0.25)
    scene3.fromTo("#text2", { opacity: 0 }, { opacity: 0.3, y: -710 }, 0.3)
